                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: <Widget>[
                      InkWell(
                        child: Hero(
                          tag: 'loginLogo',
                          child: ClipOval(
                            child: Image.asset(ImageHelper.wrapAssets('user_avatar.png'),
                                fit: BoxFit.cover,
                                width: 80,
                                height: 80,
                      ...
                      Column(children: <Widget>[
                        Text(model.hasUser ? model.user.nickname : S.of(context).toSignIn,
  ...
  Widget build(BuildContext context) {
    return ProviderWidget<CoinModel>(
        ...
        builder: (context, model, child) {
          ...
          var textStyle = Theme.of(context).textTheme.body1.copyWith(color: Colors.white.withAlpha(200), decoration: TextDecoration.underline);
          return InkWell(
              onTap: () {
                if (model.isError) {
                  model.initData();
              ...
              child: model.isError ? Text(S.of(context).retry, style: textStyle) : Text('${S.of(context).coin}：${model.coin}', style: textStyle));
        });
  }
}
...
class UserListWidget extends StatelessWidget {
  ...
  void switchDarkMode(BuildContext context) {
    if (MediaQuery.of(context).platformBrightness == Brightness.dark) {
      ...
      Provider.of<ThemeModel>(context, listen: false).switchTheme(userDarkMode: Theme.of(context).brightness == Brightness.light);
    }
  }
}
